...
const MeetCEO = () => {
    return (
        <div id="about" className=' w-screen h-screen p-[2.5%]'>
            ...
            <div className=' min-h-[90vh] flex items-center justify-between'>
                <div className=' h-[50vh] lg:h-full w-[45%]'>
                    <Image
                        src={ceo}
                        alt=''
                ...
                <div className=' w-[45%]'>
                    ...
                    <div className={`${goldman.className} flex items-start justify-between w-full`}>
                        <ol className=' w-[45%]'>
